...
function get_amount_out_balancer( amount_in: number, reserve_in: number, reserve_weight_in: number, reserve_out: number, reserve_weight_out: number, fee: number ) {
...
console.log("balancer:", get_amount_out_balancer( amount_in, reserve_in, reserve_weight_in, reserve_out, reserve_weight_out, trade_fee ));
// => 39876
