...
function quote_balancer( amount_a: number, reserve_a: number, reserve_weight_a: number, reserve_b: number, reserve_weight_b: number) {
...
console.log(quote_balancer( amount_in, reserve_in, reserve_weight_in, reserve_out, reserve_weight_out ));
// => 40000